 ...
 */
package worker.websocket.server;
...
import worker.websocket.WsWebSocketContainer;
import worker.websocket.pojo.PojoMethodMapping;
...
public class WsServerContainer extends WsWebSocketContainer
    ...
    private volatile boolean enforceNoAddAfterHandshake =
            worker.websocket.Constants.STRICT_SPEC_COMPLIANCE;
    ...
    public void addEndpoint(ServerEndpointConfig sec)
        ...
        if (methodMapping.getOnClose() != null || methodMapping.getOnOpen() != null
            ...
            sec.getUserProperties().put(worker.websocket.pojo.Constants.POJO_METHOD_MAPPING_KEY,
                    methodMapping);
        }
    ...
    public void addEndpoint(Class<?> pojo) throws DeploymentException {
        ...
        if (configurator == null) {
            configurator = new worker.websocket.server.DefaultServerEndpointConfigurator();
        }
