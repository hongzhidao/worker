...
import worker.websocket.pojo.PojoMessageHandlerPartialBinary;
import worker.websocket.pojo.PojoMessageHandlerWholeBinary;
import worker.websocket.pojo.PojoMessageHandlerWholeText;

/**
 * Utility class for internal use only within the
 * {@link worker.websocket} package.
 */
public class Util {
