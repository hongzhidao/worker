...
public class Constants {
    ...
    static final int DEFAULT_BUFFER_SIZE = Integer.getInteger(
            "worker.websocket.DEFAULT_BUFFER_SIZE", 8 * 1024)
            .intValue();
    ...
    public static final String IO_TIMEOUT_MS_PROPERTY =
            "worker.websocket.IO_TIMEOUT_MS";
    ...
    public static final String MAX_REDIRECTIONS_PROPERTY =
            "worker.websocket.MAX_REDIRECTIONS";
    ...
    static final String DEFAULT_ORIGIN_HEADER_VALUE =
            System.getProperty("worker.websocket.DEFAULT_ORIGIN_HEADER_VALUE");

    // Configuration for blocking sends
    public static final String BLOCKING_SEND_TIMEOUT_PROPERTY =
            "worker.websocket.BLOCKING_SEND_TIMEOUT";
    ...
    static final int DEFAULT_PROCESS_PERIOD = Integer.getInteger(
            "worker.websocket.DEFAULT_PROCESS_PERIOD", 10)
            .intValue();

    public static final String WS_AUTHENTICATION_USER_NAME = "worker.websocket.WS_AUTHENTICATION_USER_NAME";
    public static final String WS_AUTHENTICATION_PASSWORD = "worker.websocket.WS_AUTHENTICATION_PASSWORD";
    ...
    static final boolean DISABLE_BUILTIN_EXTENSIONS =
            Boolean.getBoolean("worker.websocket.DISABLE_BUILTIN_EXTENSIONS");
    static final boolean ALLOW_UNSUPPORTED_EXTENSIONS =
            Boolean.getBoolean("worker.websocket.ALLOW_UNSUPPORTED_EXTENSIONS");

    // Configuration for stream behavior
    static final boolean STREAMS_DROP_EMPTY_MESSAGES =
            Boolean.getBoolean("worker.websocket.STREAMS_DROP_EMPTY_MESSAGES");

    public static final boolean STRICT_SPEC_COMPLIANCE =
            Boolean.getBoolean("worker.websocket.STRICT_SPEC_COMPLIANCE");
