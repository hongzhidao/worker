...
const worker_lib = require('./build/Release/worker-http');
...
ServerResponse.prototype._send_headers = worker_lib.response_send_headers;
...
ServerResponse.prototype._write = worker_lib.response_write;
...
ServerResponse.prototype._writeBody = function(chunk, encoding, callback) {
    ...
    if (chunk) {
        ...
        if (typeof chunk === 'string') {
            ...
            if (contentLength > worker_lib.buf_min) {
...
ServerResponse.prototype._end = worker_lib.response_end;
...
ServerRequest.prototype._request_read = worker_lib.request_read;
...
function Server(requestListener) {
    ...
    this.worker = new worker_lib.Worker();
    this.worker.server = this;

    this.worker.createServer();
