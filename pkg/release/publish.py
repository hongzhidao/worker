...
def main():
    ...
    notes.write_text(
        ...
        f'See [release changes](https://github.com/hongzhidao/worker/blob/{args.tag}/CHANGES) '
        f'and the [status API documentation](https://github.com/hongzhidao/worker/blob/{args.tag}/README.md) '
        'for features and compatibility changes.\n\n'
        '## Quick Start\n\n```sh\n'
