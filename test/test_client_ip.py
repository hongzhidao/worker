...
def test_client_ip_ipv4():
    ...
    assert (
        get_xff('8.8.8.8, 84.23.23.11') == '84.23.23.11'
    ), 'xff replace'
    assert (
...
def test_client_ip_recursive():
    ...
    assert (
        get_xff('8.8.8.8, 1.1.1.1, 10.5.2.1') == '1.1.1.1'
    ), 'xff chain 3'
    assert (
    ...
    assert (
        get_xff(['8.8.8.8', '1.1.1.1, 127.0.0.1', '10.5.2.1'])
        == '1.1.1.1'
    ), 'xff replace multi 2'
    assert (
        get_xff(['10.5.2.1', '10.50.0.17, 1.1.1.1', '10.5.2.1'])
        == '1.1.1.1'
    ), 'xff replace multi 3'
    assert (
